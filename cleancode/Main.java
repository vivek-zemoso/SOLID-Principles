...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        savingsAccount.verify(new SendViaOTP());
        currentAccount.verify(new SendViaEmail());
        fixedDepositAccount.verify(new SendViaVoiceCall());

        currentAccount.sendPromotions("");
